...
var (
	...
	user      = flag.String("user", "BeginnerBot", "username for login")
	pass      = flag.String("pass", "", "password for login")
	accept    = flag.String("accept", "", "accept a game from specified user")
	gameTime  = flag.Duration("time", 10*time.Minute, "Length of game to offer")
	increment = flag.Duration("increment", 30*time.Second, "time increment to offer")
